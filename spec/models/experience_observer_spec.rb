...
describe ExperienceObserver do
    ...
    describe 'set_main method' do
      ...
      it "should set an experience as main if it was updated to being the candidate's latest one" do
        @experience1.update_attributes(:start_month => 5, :start_year => 2004, :end_month => 5, :end_year => 2005) ; @experience1.save!
    ...
    describe 'set_current_date method' do
      ...
      it 'should set the current date as the end date of a new current experience' do
         ...
         current_experience.candidate = @candidate ; current_experience.company = @company ; current_experience.save!
      ...
      it 'should set the current date as the end date of an experience updated to current' do
         ...
         past_experience.candidate = @candidate ; past_experience.company = @company ; past_experience.save!
    ...
    describe 'update_profile_completion_create method' do
      ...
      it 'should increase the profile completion by 10 when candidates with less than 3 experiences add a new one' do
    ...
    describe 'update_profile_completion_destroy method' do
      ...
      it 'should decrease the profile completion by 10 when candidates with 3 or less experiences delete one' do
        before_profile_completion_update = @candidate.profile_completion
        @experience1.destroy
        @candidate.profile_completion.should == before_profile_completion_update - 10
      end
