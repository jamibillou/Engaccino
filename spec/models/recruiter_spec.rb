...
describe Recruiter do
  ...
  before :each do
    ...
    @attr = { :first_name => 'Juan', :last_name => 'Pablo', :city => 'Madrid', :country => 'Spain', :nationality => 'Spain', :year_of_birth => 1984, :phone => '+34 6 88888888', :email => 'jp@example.net', :facebook_login => 'jp@example.net', :linkedin_login => 'jp@example.net',
              :twitter_login => '@j_pablo', :password => 'pouetpouet38', :password_confirmation => 'pouetpouet38', :quote => 'I am generally looking for finance professionals but also have opportunities elsewhere through relations.' }
  end
  
  describe 'company associations' do
    
    it { @recruiter.should respond_to :company }
  ...
  describe 'validations' do
    it { should_not validate_presence_of :quote }
    it { should ensure_length_of(:quote).is_at_most 200 }
  end
end
