...
describe ProfessionalSkillCandidate do
  ...
  before :each do
    @attr               = { :description => 'It is basically a fantastic skill which makes me very proud', :experience => '3', :level => 'expert' }
  ...
  it 'should create an instance given valid attributes' do
    ...
    professional_skill_candidate.candidate = @candidate ; professional_skill_candidate.professional_skill = @professional_skill
