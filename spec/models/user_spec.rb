  ...
  describe "mandatory attributes" do
    ...
    describe ":first_name, :last_name" do
      ...
      it "should reject empty first names or last names" do
        empty_first_name_user = User.new(@attributes.merge(:first_name => ""))
        empty_last_name_user = User.new(@attributes.merge(:last_name => ""))
        empty_name_user = User.new(@attributes.merge(:first_name => "", :last_name => ""))
    ...
    describe ":email" do
      ...
      it "should reject empty emails addresses" do
        empty_email_user = User.new(@attributes.merge(:email => ""))
    ...
    describe ":country" do
      ...
      it "should reject empty countries" do
        empty_country_user = User.new(@attributes.merge(:country => ""))
    ...
    describe ":birthdate" do
      ...
      it "should reject empty birthdates" do
        empty_birthdate_user = User.new(@attributes.merge(:birthdate => ""))
        empty_birthdate_user.should_not be_valid
      end
    
      it "should reject birthdays of users born less than 12 years ago" do
        too_recent_birthdate = 11.years.ago
        too_recent_birthdate_user = User.new(@attributes.merge(:birthdate => too_recent_birthdate))
        too_recent_birthdate_user.should_not be_valid
      end
    end
  end
  ...
  describe "optional attributes" do
    ...
    describe ":nationality" do
      ...
      it "should accept empty nationalities" do
        empty_nationality_user = User.new(@attributes.merge(:nationality => ""))
        empty_nationality_user.should be_valid
      end
      
      it "should reject invalid nationalities" do
        invalid_nationality_user = User.new(@attributes.merge(:nationality => "SAVOIE"))
    ...
    describe ":phone" do
      ...
      it "should accept empty phone numbers" do
        empty_phone_number_user = User.new(@attributes.merge(:phone => ""))
    ...
    describe ":facebook_login" do
      ...
      it "should accept empty facebook logins" do
        empty_facebook_login_user = User.new(@attributes.merge(:facebook_login => ""))
    ...
    describe ":linkedin_login" do
      ...
      it "should accept empty linkedin logins" do
        empty_linkedin_login_user = User.new(@attributes.merge(:linkedin_login => ""))
    ...
    describe ":twitter_login" do
      ...
      it "should accept empty twitter logins" do
        empty_twitter_login_user = User.new(@attributes.merge(:twitter_login => ""))
      ...
      it "should accept valid twitter logins" do
        ...
        valid_twitter_logins.each do |valid_twitter_login|
          valid_twitter_login_user = User.new(@attributes.merge(:twitter_login => valid_twitter_login))
      ...
      it "should reject invalid twitter logins" do
        ...
        invalid_twitter_logins.each do |invalid_twitter_login|
          invalid_twitter_login_user = User.new(@attributes.merge(:twitter_login => invalid_twitter_login))
          invalid_twitter_login_user.should_not be_valid
        end
      end
      
      it "should reject duplicate twitter logins" do
        duplicate_twitter_login_user = User.new(@attributes.merge(:twitter_login => @user.twitter_login))
        duplicate_twitter_login_user.should_not be_valid
      end
      
      it "should reject identical twitter logins up to case" do
        upcased_twitter_login_user = User.new(@attributes.merge(:twitter_login => @user.twitter_login.upcase))
