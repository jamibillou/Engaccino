...
describe Education do
  ...
  before :each do
    @attr = { :description => 'A lot of maths, chemical and a bit of computing sciences', :start_month => 9, :start_year => 2003, :end_month => 6, :end_year => 2005 }
  ...
  it "should create an instance given valid attributes" do
    education = Education.new @attr ; education.degree = @degree ; education.school = @school ; education.candidate = @candidate ; education.save!
  ...
  describe "validations" do
    ...
    it "should require a degree" do
      education = @candidate.educations.build @attr ; education.school = @school
      education.should_not be_valid
    end
    
    it "should require a candidate" do
      education = @degree.educations.build @attr ; education.school = @school
      education.should_not be_valid
    end
    
    it "should require a school" do
      education = @candidate.educations.build @attr ; education.degree = @degree
      education.should_not be_valid
    end   
      
    it "should accept empty descriptions" do
      empty_description_education = Education.new @attr.merge :description => ''
      empty_description_education.degree = @degree ; empty_description_education.school = @school ; empty_description_education.candidate = @candidate
    ...
    it "should reject too short descriptions" do
      ...
      short_description_education.degree = @degree ; short_description_education.candidate = @candidate ; short_description_education.school = @school
    ...
    it "should reject too long descriptions" do
      ...
      long_description_education.degree = @degree ; long_description_education.candidate = @candidate ; long_description_education.school = @school
      long_description_education.should_not be_valid
    end
    
    it "should require a start month" do
      education = Education.new @attr.merge :start_month => '' ; education.candidate = @candidate ; education.school = @school ; education.degree = @degree
      education.should_not be_valid
    end
    ...
    it "should reject invalid start months" do
      ...
      invalid_start_months.each do |invalid_start_month|
        education = Education.new @attr.merge :start_month => invalid_start_month ; education.candidate = @candidate ; education.school = @school ; education.degree = @degree
        education.should_not be_valid
      end
    end
    ...
    it "should accept valid start months" do
      ...
      valid_start_months.each do |valid_start_month|
        ...
        education.candidate = @candidate ; education.school = @school ; education.degree = @degree
        education.should be_valid
      end
    end
    ...
    it "should reject start years greater than end years" do
      ...
      greater_start_year_education.candidate = @candidate ; greater_start_year_education.school = @school ; greater_start_year_education.degree = @degree
    ...
    it "should reject start months greater than end months when start and end years are the same" do
      ...
      greater_start_month_education.candidate = @candidate ; greater_start_month_education.school = @school ; greater_start_month_education.degree = @degree
  ...
  describe "yrs_after_first_event method" do
    ...
    it "be the number of years between the the first event and the education" do
      ...
      education2.school = @school ; education2.degree = @degree ; education2.candidate = @candidate ; education2.save!
